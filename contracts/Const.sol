...
library Const {
    ...
    bytes32 public constant FUNCTION_HASH = keccak256("_joinPool(address owner,uint256 poolAmountOut,uint256[] maxAmountsIn,uint256 deadline,uint256 nonce)");

    uint256 public constant BLOCK_WAITING_TIME = 3;
