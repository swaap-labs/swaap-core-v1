...
//        uint256 diff = Num.bsub(tokenBalanceOut, tokenAmountOut);
//        uint256 y = Num.bdiv(tokenBalanceOut, diff);
//        uint256 foo = Num.bpow(y, weightRatio);
//        foo = Num.bsub(foo, Const.BONE);
//        tokenAmountIn = Num.bsub(Const.BONE, swapFee);
...
//        uint256 normalizedWeight = Num.bdiv(tokenWeightIn, totalWeight);
//        uint256 zaz = Num.bmul(Num.bsub(Const.BONE, normalizedWeight), swapFee);
//        uint256 tokenAmountInAfterFee = Num.bmul(tokenAmountIn, Num.bsub(Const.BONE, zaz));
//
//        uint256 newTokenBalanceIn = Num.badd(tokenBalanceIn, tokenAmountInAfterFee);
//        uint256 tokenInRatio = Num.bdiv(newTokenBalanceIn, tokenBalanceIn);
//
//        // uint256 newPoolSupply = (ratioTi ^ weightTi) * poolSupply;
//        uint256 poolRatio = Num.bpow(tokenInRatio, normalizedWeight);
//        uint256 newPoolSupply = Num.bmul(poolRatio, poolSupply);
//        poolAmountOut = Num.bsub(newPoolSupply, poolSupply);
...
//    {
//        uint256 normalizedWeight = Num.bdiv(tokenWeightIn, totalWeight);
///        uint256 newPoolSupply = Num.badd(poolSupply, poolAmountOut);
//        uint256 poolRatio = Num.bdiv(Num.badd(poolSupply, poolAmountOut), poolSupply);
//
//        //uint256 newBalTi = poolRatio^(1/weightTi) * balTi;
///        uint256 boo = Num.bdiv(Const.BONE, normalizedWeight);
///        uint256 tokenInRatio = Num.bpow(poolRatio, Num.bdiv(Const.BONE, normalizedWeight));
//        uint256 newTokenBalanceIn = Num.bmul(Num.bpow(poolRatio, Num.bdiv(Const.BONE, normalizedWeight)), tokenBalanceIn);
//        uint256 tokenAmountInAfterFee = Num.bsub(newTokenBalanceIn, tokenBalanceIn);
//        // Do reverse order of fees charged in joinswap_ExternAmountIn, this way
//        //     ``` pAo == joinswap_ExternAmountIn(Ti, joinswap_PoolAmountOut(pAo, Ti)) ```
//        //uint256 tAi = tAiAfterFee / (1 - (1-weightTi) * swapFee) ;
//        uint256 zar = Num.bmul(Num.bsub(Const.BONE, normalizedWeight), swapFee);
//        tokenAmountIn = Num.bdiv(tokenAmountInAfterFee, Num.bsub(Const.BONE, zar));
//        return tokenAmountIn;
//    }
...
//    returns (uint256 tokenAmountOut)
//    {
//        uint256 normalizedWeight = Num.bdiv(tokenWeightOut, totalWeight);
//        // charge exit fee on the pool token side
//        // pAiAfterExitFee = pAi*(1-exitFee)
//        uint256 poolAmountInAfterExitFee = Num.bmul(poolAmountIn, Num.bsub(Const.BONE, Const.EXIT_FEE));
//        uint256 newPoolSupply = Num.bsub(poolSupply, poolAmountInAfterExitFee);
//        uint256 poolRatio = Num.bdiv(newPoolSupply, poolSupply);
//
//        // newBalTo = poolRatio^(1/weightTo) * balTo;
//        uint256 tokenOutRatio = Num.bpow(poolRatio, Num.bdiv(Const.BONE, normalizedWeight));
//        uint256 newTokenBalanceOut = Num.bmul(tokenOutRatio, tokenBalanceOut);
//
//        uint256 tokenAmountOutBeforeSwapFee = Num.bsub(tokenBalanceOut, newTokenBalanceOut);
//
//        // charge swap fee on the output token side
//        //uint256 tAo = tAoBeforeSwapFee * (1 - (1-weightTo) * swapFee)
//        uint256 zaz = Num.bmul(Num.bsub(Const.BONE, normalizedWeight), swapFee);
//        tokenAmountOut = Num.bmul(tokenAmountOutBeforeSwapFee, Num.bsub(Const.BONE, zaz));
//        return tokenAmountOut;
//    }
...
//        uint256 zoo = Num.bsub(Const.BONE, normalizedWeight);
//        uint256 zar = Num.bmul(zoo, swapFee);
//        uint256 tokenAmountOutBeforeSwapFee = Num.bdiv(tokenAmountOut, Num.bsub(Const.BONE, zar));
//
//        uint256 newTokenBalanceOut = Num.bsub(tokenBalanceOut, tokenAmountOutBeforeSwapFee);
//        uint256 tokenOutRatio = Num.bdiv(newTokenBalanceOut, tokenBalanceOut);
//
//        //uint256 newPoolSupply = (ratioTo ^ weightTo) * poolSupply;
//        uint256 poolRatio = Num.bpow(tokenOutRatio, normalizedWeight);
//        uint256 newPoolSupply = Num.bmul(poolRatio, poolSupply);
//        uint256 poolAmountInAfterExitFee = Num.bsub(poolSupply, newPoolSupply);
//
//        // charge exit fee on the pool token side
//        // pAi = pAiAfterExitFee/(1-exitFee)
//        poolAmountIn = Num.bdiv(poolAmountInAfterExitFee, Num.bsub(Const.BONE, Const.EXIT_FEE));
//        return poolAmountIn;
//    }
